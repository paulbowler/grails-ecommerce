...
class BootStrap {
    def init = { servletContext ->
        //new Product(sku: "A10001", name: "Grand Piano", description: "A very lovely grand piano", price: 499900).save(failOnError: true)
        //new Product(sku: "B10002", name: "French Flute", description: "A shiny silver flute", price: 199500).save(failOnError: true)
        //new Product(sku: "C10003", name: "German Bassoon", description: "A mellow German bassoon", price: 299900).save(failOnError: true)
