			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'shipping.name.label', default: 'Name')}" />
				...
				<g:each in="${shippingInstanceList}" status="i" var="shippingInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${shippingInstance.id}">${fieldValue(bean: shippingInstance, field: "name")}</g:link></td>
