	...
	<body>
		...
		<div id="show-shipping" class="content scaffold-show" role="main">
			...
			<ol class="property-list shipping">
				...
				<g:if test="${shippingInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="shipping.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${shippingInstance}" field="name"/></span>
