...
Background: set up the products and empty basket
	Given I have an empty basket
		And the following items are available for purchase:
  			...
  			| A1000 | Piano   | A very lovely grand piano | 5000  |
  			| B2000 | Flute   | A shiny silver flute      | 2000  |
  			| C3000 | Bassoon | A mellow German bassoon   | 3000  |
  			| D4000 | Trumpet | A golden French trumpet   | 4000  |
...
Scenario: add single item to basket
  	...
  	Then the flash message reads "The item has been added to your basket."
  		...
  		And my basket contains 1 Piano with SKU A1000 costing 5000 units
...
Scenario: add multiple items to basket
  	...
  	Then the flash message reads "The item has been added to your basket."
  		...
  		And my basket contains 1 Flute with SKU B2000 costing 2000 units
  		And my basket contains 1 Bassoon with SKU C3000 costing 3000 units
  		And my basket contains 1 Trumpet with SKU D4000 costing 4000 units
...
Scenario: increase single item quantity
  	...
  	Then the flash message reads "Basket has been updated."
  		And I see 1 item in my basket
		And my basket contains 2 Piano with SKU A1000 costing 10000 units
